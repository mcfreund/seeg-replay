...
SET_data_root = '/oscar/home/ajaskir/brainstorm_2024/seeg-replay/src/swr/vandermeerlab_example_data'; 

restoredefaultpath;
%addpath(genpath(SET_toolbox_root));
...
cfg = []; cfg.fc = {'R064-2015-04-20-CSC07a.ncs'};
