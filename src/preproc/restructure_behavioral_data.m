...
SET_output_dir = '/oscar/data/brainstorm-ws/megagroup_data/';
SET_data_root = '/oscar/data/brainstorm-ws/seeg_data/Memory Task Data/Epilepsy/Monitoring/';
...
error_color=[]; error_position=[]; rt_color=[]; rt_location=[]; 
...
writetable(data_table, fullfile(SET_output_dir, 'behavioral_data.csv'))
